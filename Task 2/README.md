...
|---------------------------|------------------------------------------------------|--------------------------------------------------------------|
| **Login Security**        | ![Login Screen].(https://github.com/sankalpsa/-Brainwave_Matrix_Intern/blob/main/Task%202/IMAGES./Login%20Screen.png))     | SHA-256 password hashing, role-based access                  |
