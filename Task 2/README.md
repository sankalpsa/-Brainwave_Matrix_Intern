...
|---------------------------|------------------------------------------------------|--------------------------------------------------------------|
| **Login Security**        | ([Task 2/IMAGES./Login Screen.png](https://github.com/sankalpsa/-Brainwave_Matrix_Intern/blob/main/Task%202/IMAGES./Login%20Screen.png))     | SHA-256 password hashing, role-based access                  |
